...
def choose_munkey_link(request):
    ...
    if request.method == 'POST':
        form = MUNkeyLinkChooserForm(request.POST, initial=initial_data, prefix='munkey-link-chooser')
    ...
    return JsonResponse({
        "html": render_to_string("navigation/munkey-link-chooser.html", request=request, context={"form": form}),
        "step": "munkey_link",
    })
